...
Grid_res_geoid_w1 = load([OUTPUT_PARA.Grids_name,'Grid_res_geoid_w',dateCreated1,'.mat']);
Grid_res_geoid_w2 = load([OUTPUT_PARA.Grids_name2,'Grid_res_geoid_w',dateCreated2,'.mat']);
