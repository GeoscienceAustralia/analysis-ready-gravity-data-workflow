function computeMolodenskyG1LSC(GRID_PARA,COV_PARA,DEM_PARA,GRAV_PARA,GRAV_GRAD_PARA,OUTPUT_PARA,GRID_REF,Grav,Grav_grad, ...
...
%     end
    ...
    if ~isempty(Gravdatout.Long)
       ...
       [residualFreeAirGravityAnomaly]=solveGravityLSCmatrix4MolodenskyG1(GRAV_PARA,Gravdatout, ...
