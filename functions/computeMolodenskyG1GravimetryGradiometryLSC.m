function computeMolodenskyG1GravimetryGradiometryLSC(GRID_PARA,COV_PARA,DEM_PARA,GRAV_PARA, ...
    GRAV_GRAD_PARA,OUTPUT_PARA,LongDEM,LatDEM,DEM_data,GRID_REF,Grav,Grav_grad, ...
...
%     end
    ...
    if ~isempty(GravGraddatout_m)
        ...
        ACOV_dgg_grad_grav = interpolateCovarianceFunction(...
                Gravdatout.Long,         Gravdatout.Lat, RadiusBjerhammar + Gravdatout.ortho_H,...
                GravGraddatout.Long, GravGraddatout.Lat, RadiusBjerhammar + GravGraddatout.ortho_H, CCov_dgg_int_fun_RTM,OUTPUT_PARA,'ACOV_dgggradgrav',block_counter);
        ...
        CCOV_dgg_grad_dem=interpolateCovarianceFunction(...
            ...
            [LSCResidualGeoid,errorMatrixGeoid,residualFreeAirGravityAnomaly,residualBouguerGravityAnomaly,...
                errorMatrixGravity]=solveMolodenskyG1GravityGradientLSCmatrix(GRAV_PARA,GRAV_GRAD_PARA,Gravdatout,GravGraddatout,GRID_REF_dat,density, ...
