function computeGravimetryLSC(GRID_PARA,COV_PARA,DEM_PARA,GRAV_PARA,OUTPUT_PARA,GRID_REF,Grav, ...
...
%     end
    ...
    if ~isempty(Gravdatout.Long)
        ...
        ACOVggRTM_dem = interpolateCovarianceFunction(...
            ...
            GRID_REF_dat(:,1), GRID_REF_dat(:,2), ...
            RadiusBjerhammar + ZDEM_griddedInterpolant(GRID_REF_dat(:,1), GRID_REF_dat(:,2)), CCov_gg_int_fun_RTM,OUTPUT_PARA,'ACOVggRTM_dem mGal^2',block_counter);
    
        % Cross-covariance of gravity anomaly at gravity and DEM points
        CCOVggRTM_dem_grav = interpolateCovarianceFunction(...
            GRID_REF_dat(:,1), GRID_REF_dat(:,2), ...
            RadiusBjerhammar + ZDEM_griddedInterpolant(GRID_REF_dat(:,1), GRID_REF_dat(:,2)), ...
            Gravdatout.Long, Gravdatout.Lat, RadiusBjerhammar + Gravdatout.ortho_H, CCov_gg_int_fun_RTM,OUTPUT_PARA,'CCOVggRTM_dem_grav mGal^2',block_counter);
        ...
        CCOVgtRTM_dem_grav = interpolateCovarianceFunction(...
            GRID_REF_dat(:,1), GRID_REF_dat(:,2), ...
            RadiusBjerhammar + ZDEM_griddedInterpolant(GRID_REF_dat(:,1), GRID_REF_dat(:,2)), ...
            Gravdatout.Long, Gravdatout.Lat, RadiusBjerhammar + Gravdatout.ortho_H, CCov_gt_int_fun_RTM,OUTPUT_PARA,'CCOVgtRTM_dem_grav mGal^2',block_counter);
        ...
        ACOVttRTM_dem = interpolateCovarianceFunction(...
            ...
            RadiusBjerhammar + ZDEM_griddedInterpolant(GRID_REF_dat(:,1), GRID_REF_dat(:,2)), ...
            GRID_REF_dat(:,1), GRID_REF_dat(:,2), ...
            RadiusBjerhammar + ZDEM_griddedInterpolant(GRID_REF_dat(:,1), GRID_REF_dat(:,2)), CCov_tt_int_fun_RTM,OUTPUT_PARA,'ACOVttRTM_dem mGal^2',block_counter);
        ...
        ACOVggFay_dem = interpolateCovarianceFunction(...
            ...
            RadiusBjerhammar + ZDEM_griddedInterpolant(GRID_REF_dat(:,1), GRID_REF_dat(:,2)), ...
            GRID_REF_dat(:,1), GRID_REF_dat(:,2), ...
            RadiusBjerhammar + ZDEM_griddedInterpolant(GRID_REF_dat(:,1), GRID_REF_dat(:,2)), CCov_gg_int_fun_Faye,OUTPUT_PARA,'ACOVggFay_dem mGal^2',block_counter);
        ...
        CCOVgtFay_dem = interpolateCovarianceFunction(...
            ...
            RadiusBjerhammar + ZDEM_griddedInterpolant(GRID_REF_dat(:,1), GRID_REF_dat(:,2)), ...
            GRID_REF_dat(:,1), GRID_REF_dat(:,2), ...
            RadiusBjerhammar + ZDEM_griddedInterpolant(GRID_REF_dat(:,1), GRID_REF_dat(:,2)), CCov_gt_int_fun_Faye,OUTPUT_PARA,'CCOVgtFay_dem mGal^2',block_counter);
