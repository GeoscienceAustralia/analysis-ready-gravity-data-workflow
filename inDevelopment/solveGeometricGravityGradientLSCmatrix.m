function [res_Pot_g,Geoid_Error,residualFreeAirGravityAnomaly,res_grav_g_Bouguer,Grav_Error]= solveGeometricGravityGradientLSCmatrix(GRAV_PARA,GRAV_GRAD_PARA,Gravdatout,GravGraddatout,GRID_REF_dat,density, ...
...
% geometric interpolation
 ...
 %GeometricDEM=ACOV_tt_dem*inv(CCOV_tt_GPS)*(res_Pot_g-LEv);
