...
if exist([OUTPUT_PARA.Grids_name,'terrainEffects.mat'], 'file')
    ...
    [fullTopoCorrectedGravityPoint,longwaveTopo_griddedInterpolant,fullTopo_griddedInterpolant]=computeFullTerrainEffects(GRID_PARA, ...
    Topo_PARA,dataDemo.Gravity6D,gravGradFiltered,interpolantDemo.GravityGGM_griddedInterpolant,dataDemo.DEM3D,interpolantDemo.ZDEM_griddedInterpolant, ...
