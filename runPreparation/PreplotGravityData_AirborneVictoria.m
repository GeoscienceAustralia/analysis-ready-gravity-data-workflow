...
disp('Figure "GravityGradient.png" saved.');
...
figure;
scatter(AirborneGippsland(:,10),AirborneGippsland(:,11),1,AirborneGippsland(:,24));
% hold on
...
ylabel('Latitude');
grid on;
saveas(gcf, 'OtterMatGravityAnomaly.png'); % Save the figure
...
ylabel('Latitude');
grid on;
saveas(gcf, 'OtterMatHeight.png'); % Save the figure
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
