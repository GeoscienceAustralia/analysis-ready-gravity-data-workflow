...
GRID_PARA.MINLONG=141;%140;%110;%140;
GRID_PARA.MAXLONG=141.5;%154;%160;%154;
GRID_PARA.MINLAT=-38;%%-39;%-37.5;
GRID_PARA.MAXLAT=-37.5;%-33;%-27.5;
...
%% Output
outputName='OtwayFirstDouble';%'198GippslandCaravanOtter';
