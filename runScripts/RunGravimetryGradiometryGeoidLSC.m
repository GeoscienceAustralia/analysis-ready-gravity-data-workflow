...
% NSW=[140 154 -38 -27];
%[93 174 -61 -8];
GRID_PARA.MINLONG=152;%140;%110;%140;
GRID_PARA.MAXLONG=153.5;%154;%160;%154;
GRID_PARA.MINLAT=-30;%%-39;%-37.5;
GRID_PARA.MAXLAT=-28.5;%-33;%-27.5;
...
%% Output
outputName='CheckNSWgg';%'198GippslandCaravanOtter';
